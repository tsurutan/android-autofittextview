...
public class AutofitHelper {
	...
	private static float mDefaultMaxSize = -1;

	/**
	 * Creates a new instance of {@code AutofitHelper} that wraps a {@link TextView} and enables
	 * automatically sizing the text to fit.
	 */
	public static AutofitHelper create(TextView view, float defaultMaxSize) {
		mDefaultMaxSize = defaultMaxSize;
	...
	private static void autofit(TextView view, TextPaint paint, float minTextSize, float maxTextSize,
		...
		int targetWidth;
		if (mDefaultMaxSize < 0)
			targetWidth = view.getWidth() - view.getCompoundPaddingLeft() - view.getCompoundPaddingRight();
		else
			targetWidth = (int) mDefaultMaxSize - view.getCompoundPaddingLeft() - view.getCompoundPaddingRight();
